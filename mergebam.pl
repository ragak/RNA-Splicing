...
my @queries1 = ("$workdir/KO1-sorted.bam","$workdir/Rev1-sorted.bam");
my @queries2 = ("$workdir/KO2-sorted.bam","$workdir/Rev2-sorted.bam");
my @outfiles = ("$workdir/KO.bam","$workdir/Rev.bam");
my @outfiles2 = ("$workdir/KO-sorted","$workdir/Rev-sorted");
my @outfiles3 = ("$workdir/KO-sorted.bam","$workdir/Rev-sorted.bam");
my @outfiles4 = ("$workdir/KO-sorted.bai","$workdir/Rev-sorted.bai");
